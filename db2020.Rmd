...
clev_ocde <- bbo %>% 
  ...
  geom_point(data=subset(bbo, economy == "Brazil" & db_year == 2020),size=3, color = "red")+
...
ggsave(filename = "clev_ocde.pdf", width = 27, height = 30, units = "cm", dpi = "retina")
ggsave(filename = "clev_ocde.png", width = 27, height = 30, units = "cm", dpi = "retina")
