...
=======
library(xlsx)
>>>>>>> 156dcdbc1b5911c1b96eb324fc613bd66d269ab3:db202011.Rmd
...
g_ind_rank <- rank_ind %>% 
  ...
  ggplot (aes(x = indicador, y = posicao, label  = posicao))+
  geom_point(stat= "identity", fill = "black", size = 10, color = "black")+
    geom_segment(aes( y = 0,
                    x= indicador,
                    yend = posicao,
...
=======
      theme_minimal()+
           theme(legend.position="bottom",plot.caption=element_text(size=12, hjust=0, vjust = 3))+
    theme(plot.title = element_text(color = "black", size = 18, face = "bold"),
         axis.text.x = element_text(face = "bold", size = 12))
    
   
    print(a)
    ggsave(filename = paste0(bra_ind_list[i],".pdf"),plot = a, width = 30, height = 20, units = "cm", dpi = "retina")
    ggsave(filename = paste0(bra_ind_list[i],".png"),plot = a, width = 30, height = 20, units = "cm", dpi = "retina")
